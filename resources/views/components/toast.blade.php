<div id="toast-danger"
  ...
  <div id="message" class=" text-sm font-semibold">
    {{ $errors->first() }}
  </div>
...
<div id="loading"
  ...
  <div
    ...
    <div
      class="size-4 inline-block animate-spin rounded-full border-[3px] border-current border-t-transparent dark:text-blue-500"
