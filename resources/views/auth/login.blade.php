      ...
      <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="flex w-full flex-col items-center justify-center p-8 md:w-1/2">
          ...
          <form action="/auth" method="POST" class="flex w-full flex-col gap-y-2">
            ...
            <div
              class="flex w-full items-center rounded-s-sm border border-gray-300 px-4 py-2 text-gray-400 duration-300 ease-in-out focus-within:border-indigo-800 focus-within:text-blue-800 focus:transition"
          ...
          <p class="w-full">
            <a class="flex justify-end text-sm font-normal text-blue-700 hover:underline" href="/forgot-password">
