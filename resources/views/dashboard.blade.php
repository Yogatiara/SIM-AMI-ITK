<x-app-layout>
  <div class="space-y-8 font-semibold">
    <div>
      ...
      <div class="relative w-full max-w-5xl flex flex-col gap-16">

        <!-- Baris Atas (1-4) -->
        <div class="flex justify-between items-start relative z-10">
          <!-- Looping Kartu 1 sampai 4 di sini -->
          @foreach ($stages->take(4) as $stage)
            ...
            <div className="collapse bg-base-100 border border-base-300">
              ...
              <div className="collapse-content text-sm">Click the "Sign Up" button in the top right corner and follow
                the registration process.</div>
            </div>
            <div className="collapse bg-base-100 border border-base-300">
              <input type="radio" name="my-accordion-1" />
              <div className="collapse-title font-semibold">I forgot my password. What should I do?</div>
              <div className="collapse-content text-sm">Click on "Forgot Password" on the login page and follow the
        ...
        <!-- Garis Belokan (Melengkung di Kanan) -->
        <!-- Diposisikan absolut menghubungkan baris atas dan bawah -->
        <div
          class="absolute  left-[5%] top-[16%] w-[100%] h-[70%] border-t-4 border-r-4 border-b-4 border-gray-700 rounded-r-full -z-10">
        </div>

        <!-- Baris Bawah (5-8) -->
        <!-- flex-row-reverse membuat urutan dari kanan ke kiri -->
        <div class="flex flex-row-reverse justify-between items-start relative z-10">
          <!-- Looping Kartu 5 sampai 8 di sini -->
