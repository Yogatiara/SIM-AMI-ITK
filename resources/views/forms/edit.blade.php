                    ...
                    <td>
                      <div class="flex w-full justify-center md:px-20">
                        ...
                        <ul class="space-y-3">
                          ...
                          <li class="flex items-center">
                            <div class="relative flex items-center">
                              <input type="text" id="auditeeName-1" x-model="pic.user_name"
                                @input="searchUsers('auditee', 1)" name="user_names[]"
                                class="w-full rounded-e-lg border border-s-2 border-gray-300 border-s-gray-50 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                                placeholder="Search User" />
                          ...
                          <template x-for="(item, itemIndex) in otherAccesses || []" :key="item">
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                <input type="text" :id="'auditeeName-' + item.id"
                                  @input="searchUsers('auditee', item.id)" name="user_names[]"
                                  x-model="item.user.name"
                                  class="w-full rounded-e-lg border border-s-2 border-gray-300 border-s-gray-50 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                                  placeholder="Search User" />
                      ...
                      <div class="flex w-full md:px-20">
                        <ul class="space-y-3">
                          ...
                          <template x-for="(item, itemIndex) in auditors || []" :key="item">
                            <li>
                              <input :value="'Member ' + item.id" readonly name="positions[]"
                                class="items-center rounded-s-lg border border-gray-300 bg-gray-100 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" />
                            </li>
                          </template>
                        </ul>
                        <ul class="space-y-3">
                          <li class="flex items-center">
                            <div class="relative flex items-center">
                              <input type="text" id="auditorName-0" @input="searchUsers('auditor', 0)"
                                name="user_names[]"
                                class="w-full rounded-e-lg border border-s-2 border-gray-300 border-s-gray-50 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                                placeholder="Search User" />
                              <input type="hidden" id="auditorUsername-0" name="user_usernames[]" />
                              <input type="hidden" id="auditorEmail-0" name="user_emails[]" />
                          ...
                          <li class="flex items-center">
                            <div class="relative flex items-center">
                              <input type="text" id="auditorName-1" @input="searchUsers('auditor', 1)"
                                name="user_names[]"
                                class="w-full rounded-e-lg border border-s-2 border-gray-300 border-s-gray-50 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                                placeholder="Search User" />
                              <input type="hidden" id="auditorUsername-1" name="user_usernames[]'" />
                              <input type="hidden" id="auditorEmail-1" name="user_emails[]" />
                            ...
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                <input type="text" :id="'auditorName-' + item.id"
                                  @input="searchUsers('auditor', item.id)" name="user_names[]"
                                  class="w-full rounded-e-lg border border-s-2 border-gray-300 border-s-gray-50 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:border-s-gray-700 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                                  placeholder="Search User" />
                                <input type="hidden" :id="'auditorUsername-' + item.id" name="user_usernames[]" />
                                <input type="hidden" :id="'auditorEmail-' + item.id" name="user_emails[]" />
                                            ...
                                            <div class="hs-tooltip-toggle">
                                              ...
                                              <div
                                                ...
                                                <div
                                                  ...
                                                  <p x-show="!indicator.info" class="text-base">
                                                    No info
                                                    available
                                                  </p>
                                                </div>
