  ...
  <div class="flex h-full w-full flex-col">
    ...
    <div class="h-[85%] w-full" data-hs-stepper="">
      ...
      <ul class="mx-auto flex w-2/3 gap-x-2">
        ...
        <li class="group flex flex-1 shrink basis-0 items-center gap-x-2" data-hs-stepper-nav-item='{ "index": 1}'>
          <span class="min-w-7 min-h-7 group inline-flex items-center align-middle text-xs">
            <span
              ...
              <svg class="size-3 hidden shrink-0 hs-stepper-success:block" xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- End First Item -->
        <!-- Second Item -->
        <li class="group flex flex-1 shrink basis-0 items-center gap-x-2" data-hs-stepper-nav-item='{"index": 2}'>
          <span class="min-w-7 min-h-7 group inline-flex items-center align-middle text-xs">
            <span
              class="size-7 flex shrink-0 items-center justify-center rounded-full bg-white font-medium text-gray-800 group-focus:bg-gray-200 hs-stepper-active:bg-blue-600 hs-stepper-active:text-white hs-stepper-success:bg-blue-600 hs-stepper-success:text-white hs-stepper-completed:bg-teal-500 hs-stepper-completed:group-focus:bg-teal-600">
              <span class="hs-stepper-success:hidden hs-stepper-completed:hidden">
        ...
        <!-- End Second Item -->
        <!-- Third Item -->
        <li class="group flex flex-1 shrink basis-0 items-center gap-x-2" data-hs-stepper-nav-item='{"index": 3}'>
          <span class="min-w-7 min-h-7 group inline-flex items-center align-middle text-xs">
            <span
              class="size-7 flex shrink-0 items-center justify-center rounded-full bg-white font-medium text-gray-800 group-focus:bg-gray-200 hs-stepper-active:bg-blue-600 hs-stepper-active:text-white hs-stepper-success:bg-blue-600 hs-stepper-success:text-white hs-stepper-completed:bg-teal-500 hs-stepper-completed:group-focus:bg-teal-600">
              <span class="hs-stepper-success:hidden hs-stepper-completed:hidden">
          ...
          <div data-hs-stepper-content-item='{"index": 1}'>
            ...
            <div class="grid w-full grid-cols-1 gap-4 text-sm">
              ...
              <div class="flex flex-col gap-2">
                ...
                <input name="deadline" id="date-input" datepicker-format="yyyy/mm/dd" type="datetime-local"
                  value="{{ old('deadline') }}"
                ...
                <thead>
                  <tr class="sticky top-0 z-50 bg-white">
                    <th class="w-1/2 p-4 text-sm">
                      <h2 class="whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white md:text-lg">
                    ...
                    <tr>
                      <td>
                        <div class="flex w-full justify-center md:px-20">
                          <ul class="space-y-3">
                            <li>
                              <input value="Chief" readonly :name="'positions[' + option + '][]'"
                            ...
                            <li>
                              <input value="PIC" readonly :name="'positions[' + option + '][]'"
                                class="w-full items-center rounded-s-lg border border-gray-300 bg-gray-100 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" />
                            </li>
                            <template x-for="(item, itemIndex) in auditees[option] || []" :key="item">
                              <li>
                                <input :value="'PIC ' + item.id" readonly :name="'positions[' + option + '][]'"
                                  class="w-full items-center rounded-s-lg border border-gray-300 bg-gray-100 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" />
                              </li>
                            </template>
                          </ul>
                          <ul class="space-y-3">
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                ...
                                <div
                                  x-show="showResults && currentOption === option && currentRole === 'auditee' && currentItem === 0"
                            ...
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                ...
                                <input type="hidden" :id="option + '-auditeeEmail-1'"
                                  :name="'user_emails[' + option + '][]'" />
                                <div
                                  x-show="showResults && currentOption === option && currentRole === 'auditee' && currentItem === 1"
                                  class="absolute top-full z-50 mt-1 max-h-72 w-full overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2">
                                  <template x-for="user in results" :key="user.PE_Email">
                            ...
                            <template x-for="(item, itemIndex) in auditees[option] || []" :key="item">
                              <li class="flex items-center">
                                <div class="relative flex items-center">
                                  <input type="text" :id="option + '-auditeeName-' + item.id"
                                  ...
                                  <input type="hidden" :id="option + '-auditeeEmail-' + item.id"
                                    :name="'user_emails[' + option + '][]'" />
                                  <div
                                    x-show="showResults && currentOption === option && currentRole === 'auditee' && currentItem === item.id"
                                    class="absolute top-full z-50 mt-1 max-h-72 w-full overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2">
                                    <template x-for="user in results" :key="user.PE_Email">
                                  ...
                                  <button type="button" @click="removeItem(option, 'auditees', itemIndex)"
                                    ...
                                    <svg class="size-4 shrink-0 rounded-full" xmlns="http://www.w3.org/2000/svg"
                      ...
                      <td>
                        <div class="flex w-full md:px-20">
                          <ul class="space-y-3">
                            <li>
                              <input value="Leader" readonly :name="'positions[' + option + '][]'"
                            ...
                            <li>
                              <input value="Member" readonly :name="'positions[' + option + '][]'"
                                class="items-center rounded-s-lg border border-gray-300 bg-gray-100 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" />
                            </li>
                            <template x-for="(item, itemIndex) in auditors[option] || []" :key="item">
                              <li>
                                <input :value="'Member ' + item.id" readonly :name="'positions[' + option + '][]'"
                                  class="items-center rounded-s-lg border border-gray-300 bg-gray-100 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-700" />
                              </li>
                            </template>
                          </ul>
                          <ul class="space-y-3">
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                ...
                                <input type="hidden" :id="option + '-auditorEmail-0'"
                                  :name="'user_emails[' + option + '][]'" />
                                <div
                                  x-show="showResults && currentOption === option && currentRole === 'auditor' && currentItem === 0"
                                  class="absolute top-full z-50 mt-1 max-h-72 w-full overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2">
                                  <template x-for="user in results" :key="user.PE_Email">
                            ...
                            <li class="flex items-center">
                              <div class="relative flex items-center">
                                ...
                                <input type="hidden" :id="option + '-auditorEmail-1'"
                                  :name="'user_emails[' + option + '][]'" />
                                <div
                                  x-show="showResults && currentOption === option && currentRole === 'auditor' && currentItem === 1"
                                  class="absolute top-full z-50 mt-1 max-h-72 w-full overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2">
                                  <template x-for="user in results" :key="user.PE_Email">
                            ...
                            <template x-for="(item, itemIndex) in auditors[option] || []" :key="item">
                              <li class="flex items-center">
                                <div class="relative flex items-center">
                                  <input type="text" :id="option + '-auditorName-' + item.id"
                                  ...
                                  <input type="hidden" :id="option + '-auditorEmail-' + item.id"
                                    :name="'user_emails[' + option + '][]'" />
                                  <div
                                    x-show="showResults && currentOption === option && currentRole === 'auditor' && currentItem === item.id"
                                    class="absolute top-full z-50 mt-1 max-h-72 w-full overflow-hidden overflow-y-auto rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2">
                                    <template x-for="user in results" :key="user.PE_Email">
