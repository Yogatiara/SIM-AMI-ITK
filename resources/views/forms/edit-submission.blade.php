                    ...
                    <table class="w-full border-collapse">
                      <thead>
                        <tr class="bg-indigo-700 text-xs text-white md:text-sm">
                          <th class="w-[40%] border border-indigo-800 dark:border-gray-400 dark:text-white">
                            Competencies</th>
                          <th class="border border-indigo-800 dark:border-gray-400 dark:text-white">
                            Indicators</th>
                        </tr>
                      </thead>
                      <tbody>
                        <template x-for="competency in standard.competencies" :key="competency.id">
                          <tr>
                            ...
                            <td class="border border-blue-800 px-4 py-1 dark:border-gray-500 dark:text-white">
                              <template x-for="indicator in competency.indicators" :key="indicator.id">
                                <div
                                  ...
                                  <div x-show="focusIndicator.id === indicator.id"
                                    ...
                                    <div x-show="focusIndicator.id === indicator.id"
                                      ...
                                      <header class="flex justify-between">
                                        <h3 class="space-y-2 px-4 text-indigo-600 dark:text-gray-300">
                                          Set Report for
                                      ...
                                      <div
                                        class="overflow-y-auto px-4 text-gray-700 scrollbar-thin dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                        style="text-align: justify; max-height: 5rem;" x-text="indicator.assessment">
                                      </div>
                                      <!-- Modal body -->
                                      <div
                                        ...
                                        <!-- Submission Form -->
                                        <div class="flex w-full flex-col gap-y-2 text-left text-indigo-600">
                                          Submission Form
                                          <!-- Modal form -->
                                          <div class="space-y-6">
                                            ...
                                            <div class="flex items-center justify-between gap-x-3">
                                              <i class="fa-solid fa-chart-column fa-lg w-6"></i>
                                              <template x-if="indicator.entry === 'Option'">
                                                <select @input="isEditing = true" x-model="focusIndicator.validation"
                                                  class="w-[90%] border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0">
                                                  <option hidden value="">
                                                    Choose
                                                    Validation
                                              ...
                                              <template x-if="indicator.entry === 'Digit'">
                                                <div class="group relative z-0 w-[90%]">
                                                  <input @input="isEditing = true" x-model="focusIndicator.validation"
                                                    type="number" placeholder="Enter some digit"
                                              ...
                                              <template x-if="indicator.entry === 'Decimal'">
                                                <div class="group relative z-0 w-[90%]">
                                                  <input @input="isEditing = true" x-model="focusIndicator.validation"
                                                    type="number" placeholder="Enter some decimal"
                                                    class="peer w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-4 py-2.5 placeholder-transparent focus:border-indigo-600 focus:placeholder-gray-400 focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" />
                                                  <div
                                                    class="absolute top-2.5 -z-10 origin-[0] -translate-y-6 scale-75 transform px-4 text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 rtl:peer-focus:translate-x-1/4 dark:text-gray-400 peer-focus:dark:text-blue-500">
                                                    Decimal
                                              ...
                                              <template x-if="indicator.entry === 'Percentage'">
                                                <div class="group relative z-0 flex w-[90%] items-center gap-x-1">
                                                  <input @input="isEditing = true" x-model="focusIndicator.validation"
                                                    type="number" placeholder="Enter some percentage"
                                                    class="peer w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-4 py-2.5 placeholder-transparent focus:border-indigo-600 focus:placeholder-gray-400 focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                                              ...
                                              <template
                                                ...
                                                <div class="group relative z-0 w-[90%]">
                                                  <div class="px-4">
                                                    Rate 1 - 10
                                                    <span class="text-xs">(Replace
                                                      5)</span>
                                                  </div>
                                                  <input @input="isEditing = true" x-model="focusIndicator.validation"
                                                    type="range" max="10" class="w-full" />
                                              ...
                                              <template
                                                ...
                                                <div class="group relative z-0 flex w-[90%] items-center gap-x-1">
                                                  <input @input="isEditing = true" x-model="focusIndicator.validation"
                                                    type="number" placeholder="Range 1 - 100"
                                                    class="peer w-full appearance-none border-0 border-b-2 border-gray-200 bg-transparent px-4 py-2.5 placeholder-transparent focus:border-indigo-600 focus:placeholder-gray-400 focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                                            ...
                                            <div class="flex items-center justify-between gap-x-3">
                                              ...
                                              <div class="flex w-[90%] items-center">
                                                <div class="flex w-full py-0.5 text-sm text-gray-500">
                                                  <div
                                                ...
                                                <div class="hs-tooltip px-2">
                                                  <svg
                                                    class="size-6 hs-tooltip-toggle cursor-pointer text-gray-500 hover:text-indigo-600 dark:text-neutral-500 dark:hover:text-blue-500 dark:focus:text-blue-500"
                                                  ...
                                                  <div style="text-align: justify;"
                                                    ...
                                                    <h3 class="font-bold text-indigo-600">
                                                      ...
                                                      Verification
                                                      Info</h3>
                                                    <p class="text-sm" x-text="indicator.link_info">
                                                    </p>
                                                    <p class="text-sm text-gray-500" x-show="!indicator.link_info">
                                                      No info
                                                      available
                                                    </p>
                                                  </div>
