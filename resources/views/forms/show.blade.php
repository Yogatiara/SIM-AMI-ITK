<x-app-layout>
  <div x-data="form()" class="flex h-full w-full flex-col gap-y-1 font-semibold">
    ...
    <div class="flex items-center justify-between py-1 text-primaryDark dark:text-cool-gray-50 md:text-md">
      ...
      <button type="button" @click="openContact()"
        class="inline-flex gap-x-1 rounded-md border-2 border-green-400 bg-green-400 p-2 text-sm text-white transition hover:shadow-outline-green">
        <span class="hidden lg:block">Kontak</span>
      ...
      <div x-cloak x-show="isContactOpen"
        ...
        <div x-show="isContactOpen" @click.away="closeContact()" @keydown.escape="closeContact()"
          ...
          class="w-full space-y-3 overflow-hidden rounded-t-lg bg-white p-3 text-primary dark:bg-gray-700 dark:text-cool-gray-50 sm:m-4 sm:max-w-xl sm:rounded-lg"
          id="modal-contact">
    ...
    <a href="/forms"
      class="rounded-md bg-gray-500 p-2 text-xs w-min  tracking-widest text-white transition duration-150 ease-in-out hover:bg-gray-600 focus:shadow-outline-gray flex items-center gap-1 mb-4">
    ...
    <div class="flex h-[85%] w-full flex-col gap-y-2 overflow-auto">
      ...
      <div id="scrollspy-scrollable-parent-2"
        class="shadow-xs h-[90%] w-full overflow-y-auto rounded-md border-1 p-3 border-gray-200 bg-white scrollbar-thin dark:border-gray-300 dark:bg-gray-700 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800">
        <template x-for="category in categories" :key="category.id">
                ...
                <template x-for="standard in category.standards" :key="standard.id">
                  <div>
                    <div x-text="standard.name" :id="'standard-' + standard.id"
                      class="bg-white px-2 text-left  dark:border-gray-500 dark:bg-gray-700 dark:text-purple-400 sm:text-lg">
                    </div>
                    <table class="overflow-hidden rounded-lg w-full">
                      <thead>
                        <tr class="bg-primary text-xs  text-white md:text-sm">
                          <th class="w-[40%] p-2 border  dark:border-gray-400 dark:text-white">
                            Kompetensi</th>
                          <th class=" dark:border-gray-400 p-2 border dark:text-white">
                            Indikator</th>
                        </tr>
                      </thead>
                      <tbody>
                        <template x-for="competency in standard.competencies" :key="competency.id">
                          <tr class="border rounded-md">
                            <td class="p-3 dark:border-gray-500 dark:text-white">
                              <textarea x-model="competency.name" disabled
                                class="w-full resize-none overflow-hidden border-0 bg-transparent p-0 focus:ring-0" style="text-align: justify;"
                                placeholder="Competency Name">
                                                            </textarea>
                            </td>
                            <td class="  px-4 py-1 dark:border-gray-500 dark:text-white">
                              <template x-for="indicator in competency.indicators" :key="indicator.id">
                                <div class="my-4 flex w-full flex-col justify-end gap-x-4 gap-y-1 md:flex-row">
                                  <div x-text="indicator.code"
                                    class="text-sm text-gray-600 dark:border-gray-500 dark:bg-gray-700 dark:text-purple-400">
                                  </div>
                                  <div class="">
                                    <div x-text="indicator.assessment"
                                      class=" w-full border-b-2  border-b-gray-200 border-t-transparent bg-transparent text-sm text-gray-600"
                                    ...
                                    <div class="flex items-center gap-x-3">
                                      ...
                                      <template
                                        x-if="parseInt(indicator.submission_status) === parseInt(indicator.assessment_status)">
                                        <div class="text-yellow-300 dark:text-neutral-500 dark:focus:text-blue-500">
                                  ...
                                  <div x-cloak x-show="focusIndicatorId === indicator.id"
                                    ...
                                    <div x-show="focusIndicatorId === indicator.id" @keydown.escape="closeIndicator()"
                                      x-transition:enter="transition ease-out duration-150"
                                      ...
                                      <header class="flex justify-between mb-2">
                                        <div>
                                          <h3 class="space-y-2 px-4  dark:text-gray-300 text-xl">
                                          ...
                                          <h2
                                            class="overflow-y-auto px-4 text-gray-700 scrollbar-thin text-xl    dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800"
                                      ...
                                      <!-- Modal body -->
                                      <div
                                        class=" max-h-[55vh] w-full  gap-8 overflow-y-auto px-4 scrollbar-thin  mt-2 dark:scrollbar-track-gray-500 dark:scrollbar-thumb-gray-800 md:flex-row">
                                        <!-- Submission Form -->
                                        <div
                                          class="{{ $form->stage_id == 1 ? 'text-primary' : 'text-gray-600' }} mb-8 flex w-full flex-col gap-2 text-left text-lg">
                                          <span
                                            class="bg-blue-100 text-primary w-max   rounded-md font-medium me-2 px-2.5 py-0.5  dark:bg-blue-900 dark:text-blue-300">--
                                            Pengajuan --</span>
                                          <!-- Modal form -->
                                          <div class="space-y-6">
                                            <div class=" gap-3 ">
                                              <div class="flex items-center gap-3">
                                                <svg class="size-6 w-6" xmlns="http://www.w3.org/2000/svg"
                                                  fill="none" stroke="currentColor" stroke-width="2">
                                                  <path
                                                ...
                                                <h2>Nilai Indikator</h2>
                                              </div>

                                              <select x-model="indicator.submission_status" disabled
                                                class="w-full border-b-2 border-x-transparent border-b-gray-200 border-t-transparent bg-transparent focus:border-x-transparent focus:border-b-indigo-600 focus:border-t-transparent focus:ring-0">
                                                <option hidden value="">
                                                  Indicator Grade
                                                </option>
                                              ...
                                              <div class="flex  items-center">
                                                ...
                                                <template x-if="indicator.entry === 'Digit'">
                                                  <div class="group relative z-0 w-[90%]">
                                                    <input disabled x-model="indicator.validation" placeholder="Digit"
                                                ...
                                                <template x-if="indicator.entry === 'Percentage'">
                                                  <div class="group relative z-0 flex w-[90%] items-center gap-x-1">
                                                    <input disabled x-model="indicator.validation"
                                                    ...
                                                    <div class="px-3 text-lg font-bold text-gray-500">
                                                      %</div>
                                                  </div>
                                                </template>
                                                <template
                                                  ...
                                                  <div class="group relative z-0 w-[90%]">
                                                    ...
                                                    <input disabled x-model="indicator.validation" type="range"
                                                      max="10" class="w-full" />
                                                    <div class="flex w-full justify-between px-1.5 text-xs">
                                                      @for ($i = 0; $i <= 10; $i++)
                                                        <span>{{ $i }}</span>
                                                      @endfor
                                                    </div>
                                                ...
                                                <template
                                                  ...
                                                  <div class="group relative z-0 w-[90%]">
                                                    ...
                                                    <div class="flex gap-6 text-gray-400 opacity-70">
                                                      <label class="flex cursor-not-allowed items-center gap-2">
                                                        <input disabled type="radio" x-model="indicator.validation"
                                                          value="kurang">
                                                        <span>Kurang</span>
                                                      </label>
                                        ...
                                        <span
                                          class="bg-green-100 text-green-600 w-max text-lg  rounded-md font-medium me-2 p-2 dark:bg-blue-900 dark:text-blue-300">--
                                          Pemeriksaan --
                                        </span>
                                        <div class=" border-green-500 border mt-3  p-3 rounded-md">
                                          <!-- Assessment Form -->
                                          <div
                                            class="{{ $form->stage_id == 2 ? 'text-primary' : 'text-gray-500' }} flex w-full flex-col gap-y-2 text-left">
                                            <span
                                              class="bg-green-100 text-green-600 w-max text-sm  rounded-md font-medium me-2 px-2.5 py-0.5  dark:bg-blue-900 dark:text-blue-300">Formulir
                                              Penilaian</span>
                                            <!-- Modal form -->
                                            <div class="flex flex-row gap-4">
                                              <div class="flex items-center  gap-x-3 basis-1/3">
                                                <svg class="size-6 w-6" xmlns="http://www.w3.org/2000/svg"
                                                  fill="none" stroke="currentColor" stroke-width="2">
                                                  <path
                                                    d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z">
                                              ...
                                              <div class=" basis-2/3">
                                                ...
                                                <label for="message"
                                                  ...
                                                  <i class="fa-regular fa-comment-dots fa-lg w-6"></i>
                                                ...
                                                <textarea disabled id="message" rows="4" x-model="indicator.description"
                                          ...
                                          <div
                                            ...
                                            {{-- <div class="space-y-6">
                                              <div class="flex items-center justify-between gap-x-3">
                                                <i class="far fa-handshake fa-lg w-6"></i>
                                            ...
                                            <div class="flex flex-row gap-4">
                                              ...
                                              <div class=" basis-2/3">
                                                ...
                                                <textarea disabled id="message" rows="4" x-model="indicator.comment"
                                                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                                          ...
                                          <div
                                            ...
                                            <div class="flex flex-row gap-4">
                                              ...
                                              <div class=" basis-2/3">
                                                ...
                                                <textarea disabled id="message" rows="4" x-model="indicator.conclusion"
                                                  class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
                                      ...
                                      <footer
                                        ...
                                        <button @click="closeIndicator()" type="button"
                                          class="w-full rounded-lg bg-gray-500 px-5 py-3 text-sm text-white transition-colors duration-150 hover:bg-gray-700 focus:shadow-outline-indigo sm:w-auto sm:px-4 sm:py-2">
                                          Tutup
                                        </button>
                                      </footer>
                                    </div>
